...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => __WEBPACK_DEFAULT_EXPORT__\n/* harmony export */ });\n//MAIN SCREEN AUTOPLAY SLIDER\nvar slider = function slider() {\n  var slide = document.querySelectorAll('.main-slider .slide'); // const slider = document.querySelector('.portfolio-content'),\n  // dotParent = document.querySelector('.portfolio-dots');\n\n  var currentSlide = 0,\n      interval;\n\n  var prevSlide = function prevSlide(elem, index) {\n    elem[index].style.display = \"none\";\n  };\n\n  var nextSlide = function nextSlide(elem, index) {\n    elem[index].style.display = \"\";\n  };\n\n  var autoPlaySlide = function autoPlaySlide() {\n    prevSlide(slide, currentSlide); //prevSlide(dot, currentSlide, 'dot-active');\n\n    currentSlide++;\n\n    if (currentSlide >= slide.length) {\n      currentSlide = 0;\n    }\n\n    nextSlide(slide, currentSlide); //nextSlide(dot, currentSlide, 'dot-active');\n  };\n\n  var startSlide = function startSlide() {\n    var time = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 3000;\n    interval = setInterval(autoPlaySlide, time);\n  };\n\n  var stopSlide = function stopSlide() {\n    clearInterval(interval);\n  };\n\n  startSlide(5000);\n};\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (slider);\n\n//# sourceURL=webpack://LandingPage-Diploma/./src/modules/slider.js?");
